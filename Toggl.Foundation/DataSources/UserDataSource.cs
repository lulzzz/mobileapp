...
namespace Toggl.Foundation.DataSources
{
    public sealed class UserDataSource
        : SingleObjectDataSource<IThreadsafeUser, IDatabaseUser>, IUserSource
    {
        ...
        protected override ConflictResolutionMode ConflictResolution(IDatabaseUser first, IDatabaseUser second)
