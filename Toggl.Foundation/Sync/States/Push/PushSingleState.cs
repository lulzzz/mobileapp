...
{
    internal sealed class PushSingleState<TDatabaseModel, TThreadsafeModel>
        where TDatabaseModel : IDatabaseSyncable
        where TThreadsafeModel : class, TDatabaseModel, IThreadsafeModel
    {
        private readonly ISingleObjectDataSource<TThreadsafeModel, TDatabaseModel> dataSource;
        ...
        public PushSingleState(ISingleObjectDataSource<TThreadsafeModel, TDatabaseModel> dataSource)
        {
